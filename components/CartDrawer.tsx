...
// ⭐ IMPORT NOU: Funcția de plată Netopia
...
// ⭐ FIX SUPREM: BLOCARE ZOOM PE MOBILE (NUCLEAR OPTION)
  ...
  const handleSubmitOrder = async (e?: React.MouseEvent) => {
    ...
    try {
      ...
      // ⭐ PAYLOAD COMPLET PENTRU COMANDĂ
      // Acest obiect conține tot ce trebuie și pentru Netopia, și pentru Ramburs
      const orderPayload = {
      ...
      if (paymentMethod === 'card') {
        // ⭐ LOGICA NOUĂ: NETOPIA
        // Apelăm funcția din utils care face redirectul invizibil
        await processNetopiaPayment(orderPayload);
      } else {
        // LOGICA VECHE: RAMBURS (Rămâne neschimbată)
              ...
              <form id="checkout-form" className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    {/* ⭐ OPȚIUNEA CARD - MODIFICAT PENTRU NETOPIA */}
