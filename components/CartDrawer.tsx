...
export const CartDrawer: React.FC = () => {
  ...
  // =================================================================
  // ⭐ WIDGET EASYBOX - INITIALIZARE + LOCAȚIE PRECISĂ + FIX CORS
  // =================================================================
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-white shadow-2xl flex flex-col animate-slide-in-right">
        ...
        {/* ⭐ Footer COMPACT - Mai mic și mai curat */}
        {cart.length > 0 && (
          <div className="p-4 border-t border-neutral-100 bg-white shrink-0">
            ...
            <div className="flex justify-between items-center mb-3 pb-3 border-t border-neutral-200 pt-2">
