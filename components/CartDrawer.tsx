...
export const CartDrawer: React.FC = () => {
  ...
  // IMPORTANT: normalizeaza orice valoare (number/string/null) in number sigur pentru toFixed
          ...
          <div className="p-6 border-t border-neutral-100 bg-white shrink-0">
            ...
            {step === 'cart' ? (
              ...
              <Button
                ...
                className="shadow-xl"
              >
                {loading ? 'Se proceseaza...' : paymentMethod === 'ramburs' ? 'Trimite Comanda' : 'Plateste cu Cardul'}
              </Button>
            )}
          </div>
        )}
