  ...
  return (
    <footer className="bg-neutral-950 text-white pt-20 pb-10 px-6 md:px-12 mt-auto border-t border-neutral-900">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        {/* COLOANA 1: BRAND & DATE FIRMĂ (OBLIGATORIU NETOPIA) */}
        <div className="md:col-span-1">
          ...
          {/* Date de identificare - Critic pentru validare */}
        ...
        {/* COLOANA 4: PLĂȚI & NETOPIA (OBLIGATORIU CONFORM IMAGINII) */}
        <div className="flex flex-col gap-4">
            <h4 className="font-bold uppercase text-[10px] tracking-widest text-neutral-600 mb-2">Plăți Securizate</h4>
            <p className="text-xs text-neutral-500 mb-2">
              Plățile sunt procesate securizat prin partenerul nostru:
            </p>
            {/* AICI ESTE SIGLA NETOPIA - Asigură-te că ai fișierul în /public */}
            <a href="https://netopia-payments.com" target="_blank" rel="noreferrer" className="block w-fit">
              <img 
                src="/netopia-payments.png" 
                alt="Plăți Online cu Cardul - Netopia Payments, Visa, Mastercard" 
                className="h-10 w-auto object-contain bg-white/5 p-1 rounded border border-neutral-800 hover:bg-white/10 transition-colors"
              />
            </a>
     ...
     {/* STICKERE ANPC - SAL și SOL (OBLIGATORII) */}
      <div className="max-w-7xl mx-auto border-t border-neutral-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="text-[10px] uppercase tracking-widest text-neutral-600 text-center md:text-right font-mono">
          <p>&copy; {new Date().getFullYear()} Oclar. Toate drepturile rezervate.</p>
        </div>
      </div>
    </footer>
  );
