      ...
      <section className="relative min-h-screen border-b border-neutral-100 bg-white overflow-hidden">
        ...
        <div className="hidden md:flex w-full h-screen items-center relative max-w-[1920px] mx-auto px-12">
          ...
          <div className="w-[55%] relative z-20 pt-10 pointer-events-none">
            ...
            <h1 className="text-[8rem] lg:text-[8rem] xl:text-[10rem] font-black uppercase tracking-tighter mb-8 leading-[0.95] text-neutral-950 animate-slide-up-delay drop-shadow-xl pointer-events-auto select-none">
              Vezi <br/>
        ...
        {/* ---------------- MOBILE LAYOUT (<768px) - 3D MODEL VIZIBIL ---------------- */}
        <div className="md:hidden relative w-full min-h-[100svh] bg-white overflow-hidden">
           ...
           <div className="relative z-20 px-5 pt-16 pb-2 pointer-events-none">
              ...
              <h1 className="text-[3.5rem] leading-[0.9] font-black uppercase tracking-tighter text-neutral-950 animate-slide-up-delay drop-shadow-lg">
                Vezi <br/>
                <span className="text-neutral-400">Până La</span><br/>
                Capăt.
              </h1>
           </div>

           {/* 2. CONTAINER 3D MODEL - VIZIBIL ȘI INTERACTIV */}
           <div className="relative z-10 px-5 py-8" style={{height: '320px'}}>
              {/* Glow effect */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] bg-brand-yellow/20 rounded-full blur-[80px] pointer-events-none"></div>
           ...
           {/* 3. TEXT + BUTOANE - JOS */}
           <div className="relative z-30 px-5 pb-8 pt-4">
              <p className="text-neutral-600 text-sm font-medium mb-6 text-center leading-tight">
