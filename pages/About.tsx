    ...
    <main className="bg-white min-h-screen overflow-hidden">
      ...
      <section className="relative h-[80vh] flex flex-col justify-center px-6 md:px-12 border-b border-neutral-100">
        ...
        <div className="relative z-10 max-w-[1920px] mx-auto w-full pt-20">
            ...
            <h1 className="text-[15vw] md:text-[10rem] leading-[1] font-black uppercase tracking-tighter text-neutral-950 animate-slide-up-delay drop-shadow-sm mix-blend-multiply">
              Viziune <br/>
